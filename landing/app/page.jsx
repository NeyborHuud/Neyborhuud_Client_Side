...
import { ShieldCheck, MapPin, Store, BadgeCheck, Users, Bell, Lock, Map, Zap, CheckCircle2, Star, ChevronRight, Search, Sparkles } from "lucide-react";
import { InteractiveMockup } from "./components/landing/InteractiveMockup";
import { IntelTerminal } from "./components/landing/IntelTerminal";
import { InteractiveCards } from "./components/landing/InteractiveCards";
import { DayInTheHuud } from "./components/landing/DayInTheHuud";
...
export default function Home() {
  ...
  return (
    <div ref={containerRef} style={{ position: "relative" }}>
        ...
        <div className="container" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 480px), 1fr))", gap: "60px", alignItems: "center" }}>
          ...
          <motion.div style={{ y: heroTextY, zIndex: 10 }} initial="hidden" animate="visible" variants={containerVariants}>
            ...
            <motion.div variants={itemVariants} style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
              <motion.button onClick={() => window.location.href = "https://app.neyborhuud.com/"} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="btn-glass-primary shadow-premium" style={{ padding: "20px 40px", fontSize: "1rem" }}>
                Claim Your Address
              </motion.button>
            </motion.div>
          </motion.div>
      ...
      {/* 4. Interactive mosaic cards: "Cards Crazy" */}
      ...
      {/* 6. Final CTA */}
      <section className="cta-section text-center" style={{ background: "var(--bg-secondary)", position: "relative", overflow: "hidden", borderBottom: "1px solid var(--border-subtle)" }}>
        ...
        <div className="container relative z-10">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
            <motion.button onClick={() => window.location.href = "https://app.neyborhuud.com/"} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="btn-glass-primary shadow-premium" style={{ fontSize: "1.1rem", padding: "24px 48px" }}>
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 250px), 1fr))", gap: "60px", marginBottom: "80px" }}>
            ...
            <div>
              ...
              <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "16px" }}>
                <li><a href="#" style={{ color: "var(--text-muted)", fontWeight: 650 }} className="text-editorial">Privacy Policy</a></li>
                <li><a href="#" style={{ color: "var(--text-muted)", fontWeight: 650 }} className="text-editorial">Terms of Service</a></li>
                <li><a href="#" style={{ color: "var(--text-muted)", fontWeight: 650 }} className="text-editorial">NDPR Compliance</a></li>
              </ul>
            </div>
          </div>
