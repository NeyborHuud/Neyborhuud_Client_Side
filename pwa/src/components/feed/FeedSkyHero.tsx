  ...
  return (
    <section className="feed-sky-hero flex flex-col">
      ...
      <div className="feed-sky-scene relative transition-all duration-[2000ms]">
        ...
        <div className="feed-sky-scene__content" style={{ bottom: '3.25rem' }}>
          ...
          <div className="feed-sky-scene__composer z-30 w-full flex flex-col px-1" style={{ marginBottom: '8px' }}>
            <div
